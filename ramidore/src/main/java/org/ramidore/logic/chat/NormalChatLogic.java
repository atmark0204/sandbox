...
import org.ramidore.bean.NormalChatTable;
...
public class NormalChatLogic extends AbstractChatLogic {
     ...
     */
    private static final String PATTERN = "^..002811CDCDCDCD..000000(?:.{2})+005811CCCCCCCC..C80CC0" + Const.BASE_PATTERN + "00"
    ...
    public final boolean execute(final PacketData data) {
        ...
        if (matcher.matches()) {
            ...
            addData(new NormalChatTable(data.getDate(), name, content));
