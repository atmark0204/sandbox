...
public class GuildChatLogic extends AbstractChatLogic {
     ...
     */
    private static final String PATTERN = "^..005811CCCCCCCCCC(....)C0" + BASE_PATTERN + "00" + BASE_PATTERN + "000000$";
    ...
    public boolean execute(final PacketData data) {
        ...
        if (matcher.matches()) {
            ...
            String name = RamidoreUtil.encode(matcher.group(2), ENCODING);

            String content = RamidoreUtil.encode(matcher.group(3), ENCODING);
